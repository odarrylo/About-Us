    ...
    <div class="content">
        ...
        <div class="team-section box">
            ...
            <div class="carousel-container">
                ...
                <div class="carousel">
                    <div class="member"><img src="logo.jpg" alt="Kervy"><h4>Deejay Kervy Garcia</h4><p>Team Leader</p></div>
                    <div class="member"><img src="logo.jpg" alt="Darryl"><h4>Darryl Salumag</h4><p>Backend Developer</p></div>
                    <div class="member"><img src="logo.jpg" alt="Abigail"><h4>Abigail Castelo</h4><p>Frontend Developer</p></div>
                    <div class="member"><img src="logo.jpg" alt="Reden"><h4>Reden Camarillo</h4><p>UI/UX Designer</p></div>
                    <div class="member"><img src="logo.jpg" alt="Raiche"><h4>Raiche Nicole Pantaleon</h4><p>Documentation</p></div>
                    <div class="member"><img src="logo.jpg" alt="Arthur"><h4>John Arthur Tuliao</h4><p>Researcher</p></div>
                    <div class="member"><img src="logo.jpg" alt="Steven"><h4>Steven Andrei Barcibal</h4><p>Database Manager</p></div>
                    <div class="member"><img src="logo.jpg" alt="Izzy"><h4>Izzy Ignacio</h4><p>QA Tester</p></div>
                    <div class="member"><img src="logo.jpg" alt="Zander"><h4>Zander Ace Rodica</h4><p>Assistant Dev</p></div>
                    <div class="member"><img src="logo.jpg" alt="Arjay"><h4>Arjay Vergara</h4><p>Marketing</p></div>
                    <div class="member"><img src="logo.jpg" alt="Renuel"><h4>Renuel Palada</h4><p>Content Creator</p></div>
                </div>
